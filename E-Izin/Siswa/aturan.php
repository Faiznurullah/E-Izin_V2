...
<h6 class="m-0 font-weight-bold text-primary">Izin SIswa:</h6>
                 ...
                 <div class="card-body">
                   ...
                   <center><img class="mt-2" src="../img/aturan.png" alt="Gambar" width="150px" height="150px"></center>

                   </div>

                   <div class="col-md-8 mt-4">
              <h2>Aturan Surat Izin:</h2>
              <p><b>1.Hanya Boleh Kirim Maximal 1x Sehari.</b></p>
              <p><b>2.Penamaan File Surat Izin Harus Nama_Kelas.pdf</b></p>
