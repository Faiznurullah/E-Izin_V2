          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="../img/user.png" alt="Photo" width="16" height="16">
              </a>
...
<?php
$key = $_COOKIE["user_login"];
$password = $_COOKIE["userpassword"];
$det=mysqli_query($conn, "select * from siswa where nama='$key' and nik='$password'");
...
<h6 class="m-0 font-weight-bold text-primary">Profile:</h6>
  ...
  <center><img class="mt-2" src="../img/siswa.png" alt="Gambar" width="150px" height="150px"></center>

    </div>
    <div class="col-md-8">
      <center><p><b><h6>Data Diri</h6></b></p></center>
       <table class="table">
      <tr>
        <td>Nama:</td>
