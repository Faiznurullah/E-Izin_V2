...
<h6 class="m-0 font-weight-bold text-primary">Tambah Kelas Siswa:</h6>
            ...
            <div class="card-body">
              ...
              <input class="form-control form-control-sm" type="number" placeholder="Nik Siswa..." aria-label=".form-control-sm example" name='nik' required>
              </div>
              ...
              <?php
               ...
               $nik = htmlspecialchars($_POST['nik']);
                  ...
                  $wet =mysqli_query($conn, "select * from siswa where nama ='$nama'");
