...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <?php
            ...
            $det=mysqli_query($conn, "select * from siswa where id='$id_brg'");
  ...
  <h6 class="m-0 font-weight-bold text-primary">Edit Data Siswa:</h6>
       ...
       <P><b>Nama Siswa:</b></p>
         <input class="form-control" type="text" name='nama' placeholder="Nama Siswa..."  value="<?php echo $d['nama']; ?>" required>

         <label>Kelas:</label>
           <select class="form-control" name='kelas' required>
           <option selected disabled value="">Nama Kelas</option>
             <?php
              $brg=mysqli_query($conn, "select * from kelas");
              while($b=mysqli_fetch_array($brg)){
                ?>
             <option value="<?php echo $b['nama_kelas']; ?>"><?php echo $b['nama_kelas']; ?></option>

                <?php } ?>
           </select>

          <P><b>Nik Siswa:</b></p>
          <input class="form-control" type="text" name='nik'  placeholder="Nik Siswa..." value="<?php echo $d['nik']; ?>" required>
        ...
        <?php
          ...
          if(isset($_POST['edit'])){
           ...
           $nik= htmlspecialchars($_POST['nik']);
                             ...
                             $wet =mysqli_query($conn, "select * from siswa where nama ='$nama' or nik like '%".$nik."%'");
