      ...
      <div id="content">
        ...
        <div class="container-fluid">
                  ...
                  if($ggl){
                    ...
                    $det=mysqli_query($conn, "select * from kelas where id='$id_brg'")or die(mysql_error());
                    while($d=mysqli_fetch_array($det)){
                      ...
                      <h6 class="m-0 font-weight-bold text-primary">Info Kelas Siswa:</h6>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body">
                      <!-- Content Row -->
          <div class="row ml-5">
            <div class="col-md-10 col-sm-12 col-xs-12">
              <h2><center>Info Detail Kelas</center></h2>
          	<table class="table">
          ...
          <?php
           ...
           <div class="col-md-3">
           <a href="kelas.php"><button type="button" class="btn btn-info">Kembali Lagi</button></a>
           </div>
