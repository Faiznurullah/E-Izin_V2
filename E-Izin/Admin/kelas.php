  ...
  <div id="wrapper">
   ...
   <h6 class="m-0 font-weight-bold text-primary">Data Kelas Siswa:</h6>
                ...
                <div class="card-body">
                  ...
                  $jumlah_cos=mysqli_query($conn,"SELECT COUNT(*) as id from kelas");
           ...
           <h7 class="m-0 font-weight-bold">Kapasitas Kelas Siswa: <?php echo $kap; ?></h7><br>
           <a href="export_kelas.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>

                   </div>

                   <div class="col-md-4 mt-5 ">
                     <form class="form-inline my-2 my-lg-0" action="cari_kelas.php" method="get" name='cari'>
...
if(isset($_GET['hapus'])){
   ...
   echo "</div>";
                   ...
                   if(isset($_GET['cari'])){
                    ...
                    $brg=mysqli_query($conn, "select * from kelas where id like '%".$cari."%' or nama_kelas like '%".$cari."%' or wali_kelas like '%".$cari."%' ");
                 ...
                 if(mysqli_num_rows($brg) > 0){
                    ...
                    $brg=mysqli_query($conn, "select * from kelas limit $start, $hal");
                  }
                 ...
                 if(mysqli_num_rows($brg)){
                   ...
                   <tbody>
                     <tr>
                       ...
                       <td>&nbsp;<a href="edit_kelas.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; <a href="hapus_kelas.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp; <a href="detail_kelas.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-info">Detail</button></a></td>
