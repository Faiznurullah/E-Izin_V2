...
<body id="page-top">
  ...
  <div id="wrapper">
   ...
   <h6 class="m-0 font-weight-bold text-primary">Data Surat Izin Siswa:</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <?php

                  $jumlah_cos=mysqli_query($conn,"SELECT COUNT(*) as id from surat");
           ...
           <h7 class="m-0 font-weight-bold">Kapasitas Surat Izin: <?php echo $kap; ?></h7><br>
           <a href="export_surat.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>

                   </div>

                   <div class="col-md-4 mt-5 ">
                     <form class="form-inline my-2 my-lg-0" action="cari_surat.php" method="get" name='cari'>
...
if(isset($_GET['hapus'])){
   ...
   echo "</div>";
                   ...
                   if(isset($_GET['cari'])){
                    ...
                    $brg=mysqli_query($conn, "select * from surat where id like '%".$cari."%' or nama like '%".$cari."%' or kelas like '%".$cari."%' ");
                 ...
                 if(mysqli_num_rows($brg) > 0){
                    ...
                    $brg=mysqli_query($conn, "select * from surat limit $start, $hal");
                  }
                 ...
                 if(mysqli_num_rows($brg)){
                   ...
                   <tbody>
                     <tr>
                       ...
                       <td>&nbsp; <a href="hapus_surat.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp; <a href="detail_surat.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-info">Detail</button></a></td>
