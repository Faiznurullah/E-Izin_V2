...
<h6 class="m-0 font-weight-bold text-primary">Tambah Kelas Siswa:</h6>
            ...
            <div class="card-body">
              ...
              <input class="form-control form-control-sm" type="text" placeholder="Nama Kelas..." aria-label=".form-control-sm example" name='kelas' required>
              </div>


              <div class="col-sm-5">
              <label>Nama WaliKelas:</label>
              <input class="form-control form-control-sm" type="text" placeholder="Nama Walikelas..." aria-label=".form-control-sm example" name='walikelas' required>
              </div>
              ...
              <?php
               ...
               $nama = htmlspecialchars($_POST['kelas']);
               $wali = htmlspecialchars($_POST['walikelas']);




                  $wet =mysqli_query($conn, "select * from kelas where nama_kelas ='$nama' or wali_kelas like '%".$wali."%'");
               ...
               $insert = mysqli_query($conn, "INSERT INTO kelas VALUES (
                NULL,
                '$nama',
                '$wali'
                  )");
