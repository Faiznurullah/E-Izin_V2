...
<html lang="en">
  ...
  <!--ini awal content-->
  <h3><p class="text-center mt-4">Data Kelas Dan Walimurid</p></h3>

    <center><table class=" mt-4" width="1000px" border="1">
        <tr>
       <td><center>No</td>
   		 <td><center>Nama Kelas</td>
   		 <td><center>Nama Walimurid</td>
         </tr>
         ...
         <?php
            ...
            <td><center><?php echo $row['nama_kelas'] ?></td>
            <td><center><?php echo $row['wali_kelas'] ?></td>
             </tr>
  <?php
  }
    ?>
