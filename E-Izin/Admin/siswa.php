...
<body id="page-top">
  ...
  <div id="wrapper">
   ...
   <h6 class="m-0 font-weight-bold text-primary">Data Siswa:</h6>
           ...
           <a href="export_siswa.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
...
if(isset($_GET['hapus'])){
   ...
   echo "</div>";
                   ...
                   if(isset($_GET['cari'])){
                    ...
                    $brg=mysqli_query($conn, "select * from siswa where id like '%".$cari."%' or nama like '%".$cari."%' or kelas like '%".$cari."%' or nik like '%".$cari."%' ");
                 ...
                 if(mysqli_num_rows($brg) > 0){
                    ...
                    $brg=mysqli_query($conn, "select * from siswa limit $start, $hal");
                  }
                 ...
                 if(mysqli_num_rows($brg)){
                   ...
                   <tbody>
                     <tr>
                       ...
                       <td>&nbsp;<a href="edit_siswa.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; <a href="hapus_siswa.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp; <a href="detail_siswa.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-info">Detail</button></a></td>
